...
RAID_TEXTS = [
"2-3 mahine huye nhi hagne lge",

"𝘛𝘌𝘙𝘐 𝘔𝘈 𝘉𝘓𝘈𝘊𝘒 𝘉𝘜𝘙 𝘘𝘜𝘌𝘌𝘕",
"T̷E̷R̷I̷ ̷M̷A̷ ̷K̷A̷ ̷B̷H̷O̷S̷D̷A̷ ̷C̷R̷A̷C̷K̷�̷�̷✔̷🤪✔🖍🖍🖍🖍🖍",
"sale itni gc bna dunga saal bhr v ginega  gin ni pyga",
"teri ma ka bhosda",
...
"teri ma ko चोद dunga",
"🏃🏻🏃🏻🏃🏻🏃🏻 teri maa chodke bhaaga abusive",
"Teri ma ki चुत me 🥚 dalke fry krdunga 🤙🏻",
"tri ma rndy",
"Yeh kya bola mc teri maa 100% rndy h😂👌🏼😂👌🏼",
...
"JⱧɄⱠ₳ JⱧɄⱠ ฿₳₳₱ ₭Ø ₥₳₮ ฿ⱧɄⱠ😈🤙🏻🔥",
"teri ma ki chati pr lund marunga",
"हमारे < abhi > भाई को गाली देगा रंडीके तुझे मारेंगे यही delhi मयूर विहार में जब मारेंगे देख लेना>🔥🔥",
"ये 𝙎𝙇𝑰𝘿𝙀 करके तू 𝘼𝙋𝙉𝑰 मां नहीं B聲🇨🇭A पाएगा ~ 🤪👌🏻"]
...
"NAME 𝐊𝐄 𝐁𝐀𝐀𝐏 𝘼𝘽𝙐𝙎𝙄𝙑𝙀 𝐘𝐄𝐇 𝐇𝐀𝐈 𝐈𝐍𝐊𝐈 𝐌𝐀𝐀 𝐊𝐄 𝐘𝐀𝐀𝐑 ???? 😆🩶🤚🏼",
...
"𝙄𝙕𝙕𝘼𝙏 𝙆𝙍𝙊 𝙏𝙐𝙈𝙃𝘼𝙍𝙀 𝘽𝘼𝘼𝙋 𝘼𝘽𝙐𝙎𝙄𝙑𝙀 𝙆𝙄 😑🙌🏾",
"𝙂𝘼𝘿𝘿𝙃𝘼 𝘿𝙄𝙆𝙃𝘼 𝙆𝙃𝙊𝘿 𝘿𝙄𝙔𝘼 𝙏𝙀𝙍𝙄 𝙈𝘼𝘼 𝘿𝙄𝙆𝙃𝙄 𝘾𝙃𝙊𝘿 𝘿𝙄𝙔𝘼 🙊🤦🏾😂",
"𝘼𝘽𝙐𝙎𝙄𝙑𝙀 𝘽𝘿𝙈𝙊𝙎𝙃 𝙎𝙋𝙀𝘼𝙆𝙄𝙉𝙂 𝙁𝙍𝙊𝙈 𝙏𝙀𝙍𝙄 𝙈𝙆𝘽🤦🏾☎️ ",
"𝘾𝙐𝘿𝙉𝘼 𝙈𝙉𝘼 𝙃𝘼𝙄 😩🤟🏻",
...
"𝘼𝘽𝙐𝙎𝙄𝙑𝙀 𝙂𝙉𝘿 𝙈𝘼𝘼𝙍 𝙍𝙃𝙀 𝙃𝘼𝙄 👻",
"𝙃𝙔 𝘾𝙊𝙏𝙐 𝘽𝙃𝙂 𝙈𝙏 𝙍𝙉𝘿𝙔 𝙆𝙀 🔥😑👍🏾",
"𝘽𝙃𝘼𝙂𝙉𝘼 𝙈𝘼𝙉𝘼 𝙃𝘼𝙄 𝙅𝙄 🚫😎",
"𝘼𝘽𝙐𝙎𝙄𝙑𝙀 𝘼𝘽𝘽𝙐 𝘼𝘼𝙂𝙔𝙀 🤣🩷🙌🏾",
"𝙏𝙀𝙍𝙄 𝙈𝘼𝘼 𝙈𝘼𝙍𝙆𝙀 𝙈𝙅𝘿𝙐𝙍𝙄 𝙆𝙃𝙏𝙈 👍🏾👍🏾👍🏾👍🏾👍🏾",
"𝙆𝙔𝘼 𝘼𝘽𝙐𝙎𝙄𝙑𝙀 𝙏𝙀𝙍𝘼 𝘽𝘼𝘼𝙋 𝙃𝘼𝙄 👻❓",
"𝙆𝙔𝘼 𝙈𝙏𝙇𝘽 𝙏𝙀𝙍𝙄 𝙈𝘼𝘼 𝘼𝘽𝙐𝙎𝙄𝙑𝙀 𝙉𝙀 𝘾𝙊𝘿𝙄 😹🖕🏾😹🖕🏾💔",
"𝙏𝙀𝙍𝙄 𝘽𝙃𝙀𝙉 𝙈𝘼𝙍𝙆𝙀 𝘽𝙃𝘼𝙂 𝙅𝘼𝙐𝙉𝙂𝘼 🙋🏾🤪",
"𝙏𝙀𝙍𝙄 𝘽𝙃𝙀𝙉 𝙈𝘼𝙍𝙆𝙀 𝘼𝘽𝙐𝙎𝙄𝙑𝙀 𝘽𝙃𝘼𝙂 𝙂𝙔𝘼 🤦🏾💔",
"𝘽𝙃𝘼𝙂 𝙌 𝙍𝙃𝘼 𝙃𝘼𝙄 ❓",
...
"𝙄𝙕𝙕𝘼𝙏 𝙆𝙍𝙀𝙂𝘼 𝘼𝘼𝙅𝙎𝙀 𝘼𝘽𝙐𝙎𝙄𝙑𝙀 𝘼𝘽𝘽𝙐 𝙆𝙄 😂🤟🏻😂🤟🏻",
"𝙏𝙀𝙍𝙄 𝘽𝙃𝙀𝙉 𝙆𝙄 𝙋𝙊𝙊𝙆𝙄𝙀 𝙂𝙓𝙉𝘿 𝙈𝙀 𝙇𝙐𝙉 🎀",
"𝘽𝙃𝘼𝙂 𝙈𝙏 𝘽𝙀𝙏𝙀 😑🙌🏾😑🙌🏾",
"𝙄𝘿𝙃𝙍 𝘼𝙅𝘼 𝙇𝘼𝘿𝙇𝙀 😉❤️",
"𝙏𝙀𝙍𝙄 𝙂𝙀𝙉𝘿 𝙈𝙀 100 𝙃𝘼𝙏𝙃 💯🔥",
"𝙆𝙍 𝘼𝘽 𝙃𝘼𝙒𝘼𝘽𝘼𝘼𝙕𝙄?",
"𝙇𝙀 𝘼𝘼𝙂𝙔𝘼 𝙏𝙀𝙍𝘼 𝘽𝘼𝘼𝙋 𝘼𝘽𝙐𝙎𝙄𝙑𝙀 👻👑",
...
"𝙃𝙇𝙒 𝘾𝙐𝘿𝙂𝙔𝙄 𝙆𝙔𝘼 💀😹",
"𝘼𝘽𝙐𝙎𝙄𝙑𝙀 𝘼𝘼𝙂𝙔𝘼 👻🔥",
"𝙏𝙀𝙍𝙀 𝘽𝘼𝘼𝙋 𝘼𝘽𝙐𝙎𝙄𝙑𝙀 𝙆𝙄 𝙀𝙉𝙏𝙍𝙔 👻😂",
"𝙍𝙀𝙈𝙀𝙈𝘽𝙀𝙍 𝙏𝙃𝙀 𝙂𝙊𝘿 𝙆𝙀𝙉𝙂 𝘼𝘽𝙐𝙎𝙄𝙑𝙀 👻👑"
]
